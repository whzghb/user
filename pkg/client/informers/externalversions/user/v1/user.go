...
import (
	...
	internalinterfaces "user/pkg/client/informers/externalversions/internalinterfaces"
	v1 "user/pkg/client/listers/user/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StableV1().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StableV1().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&userv1.User{},
		resyncPeriod,
